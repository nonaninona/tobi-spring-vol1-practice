...
import com.example.chapter6.v4.mailSender.MockMailSender;
...
import com.example.chapter6.v4.userService.UserService;
import com.example.chapter6.v4.userService.UserServiceDynamicProxy;
import com.example.chapter6.v4.userService.UserServiceImpl;
...
import static com.example.chapter6.v4.upgradeLevelPolicy.DefaultUserLevelUpgradePolicy.MIN_LOGIN_COUNT_FOR_SILVER;
import static com.example.chapter6.v4.upgradeLevelPolicy.DefaultUserLevelUpgradePolicy.MIN_RECOMMENED_COUNT_FOR_GOLD;
...
public class UserServiceTest {
    ...
    private static class MockUserDao implements UserDao {
        ...
        @Override
        public void add(com.example.chapter6.v4.User user) {throw new UnsupportedOperationException();}
        @Override
