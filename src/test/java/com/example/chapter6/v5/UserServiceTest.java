...
import com.example.chapter6.v5.mailSender.MockMailSender;
import com.example.chapter6.v5.proxy.TransactionHandler;
...
import static com.example.chapter6.v5.upgradeLevelPolicy.DefaultUserLevelUpgradePolicy.MIN_LOGIN_COUNT_FOR_SILVER;
import static com.example.chapter6.v5.upgradeLevelPolicy.DefaultUserLevelUpgradePolicy.MIN_RECOMMENED_COUNT_FOR_GOLD;
...
public class UserServiceTest {
    ...
    @Autowired
    private com.example.chapter6.v5.UserDao userDao;
    @Autowired
